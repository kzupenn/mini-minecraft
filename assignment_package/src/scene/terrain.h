...
private:
    ...
    std::map<int64_t, StructureType> metaStructures; //marks the meta structure to prevent regeneration
    std::map<std::pair<int64_t, int>, Structure> metaSubStructures; //stores the structures generated by the metaStructure
    //vbo workers
